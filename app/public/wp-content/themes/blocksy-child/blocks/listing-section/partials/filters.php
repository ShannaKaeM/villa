...
<div class="filter-sidebar">
    <h3 class="filter-sidebar__title title-sidebar">
        <?php 
    ...
    <?php if ($post_type === 'business') : ?>
        ...
        if (!empty($business_types) && !is_wp_error($business_types)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Business Type', 'miblocks'); ?></h4>
                <div class="filter-group">
                    <?php foreach ($business_types as $type) : ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__count"><?php echo $type->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
        ...
        if (!empty($locations) && !is_wp_error($locations)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Location', 'miblocks'); ?></h4>
                <div class="filter-group">
                    <?php foreach ($locations as $location) : ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__label"><?php echo esc_html($location->name); ?></span>
                            <span class="filter-checkbox__count"><?php echo $location->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <?php elseif ($post_type === 'property') : ?>
        ...
        if (!empty($property_types) && !is_wp_error($property_types)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Property Type', 'miblocks'); ?></h4>
                <div class="filter-group">
        ...
        <div class="filter-section">
            <h4 class="filter-section__title"><?php _e('Bedrooms', 'miblocks'); ?></h4>
            <div class="filter-range">
                <div class="filter-range__label">
                    <span><?php _e('Minimum Bedrooms', 'miblocks'); ?></span>
                    <span class="filter-range__value"><span>0</span>+</span>
                </div>
                <input type="range" 
        ...
        <div class="filter-section">
            <h4 class="filter-section__title"><?php _e('Bathrooms', 'miblocks'); ?></h4>
            <div class="filter-range">
                <div class="filter-range__label">
        ...
        if (!empty($amenities) && !is_wp_error($amenities)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Amenities', 'miblocks'); ?></h4>
                <div class="filter-group">
                    ...
                    ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__label"><?php echo esc_html($amenity->name); ?></span>
                            <span class="filter-checkbox__count"><?php echo $amenity->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <?php elseif ($post_type === 'profile') : ?>
        ...
        if (!empty($roles) && !is_wp_error($roles)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Role', 'miblocks'); ?></h4>
                <div class="filter-group">
                    <?php foreach ($roles as $role) : ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__label"><?php echo esc_html($role->name); ?></span>
                            <span class="filter-checkbox__count"><?php echo $role->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <?php elseif ($post_type === 'article') : ?>
        ...
        if (!empty($categories) && !is_wp_error($categories)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Categories', 'miblocks'); ?></h4>
                <div class="filter-group">
                    <?php foreach ($categories as $category) : ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__label"><?php echo esc_html($category->name); ?></span>
                            <span class="filter-checkbox__count"><?php echo $category->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
        ...
        if (!empty($article_types) && !is_wp_error($article_types)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Article Type', 'miblocks'); ?></h4>
                <div class="filter-group">
        ...
        if (!empty($tags) && !is_wp_error($tags)) : ?>
            <div class="filter-section">
                <h4 class="filter-section__title"><?php _e('Tags', 'miblocks'); ?></h4>
                <div class="filter-group">
                    <?php foreach ($tags as $tag) : ?>
                        <label class="filter-checkbox">
                            ...
                            <span class="filter-checkbox__label"><?php echo esc_html($tag->name); ?></span>
                            <span class="filter-checkbox__count"><?php echo $tag->count; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
